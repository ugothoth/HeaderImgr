...
{
    public class NaiveBitmapBoxBlurrerTests
    {
        public class TheConstructor
        {
            [Property]
            public void ThrowsWithNegativeRadius(NegativeInt negativeInt)
            {
                Action constructorWithNegativeRadius =
                    () => _ = new NaiveBitmapBoxBlurrer(negativeInt.Get);
        ...
        public class TheApplyMethod
        {
            ...
            {
                var blurrer = new NaiveBitmapBoxBlurrer(0);
            ...
            public void ReturnsEquivalentImageForAnyRadiusIfImageIsSinglePixel(NonNegativeInt radius, int seed)
            {
                ...
                var blurrer = new NaiveBitmapBoxBlurrer(radius.Get);
            ...
            public void ReturnsConstantColorImageIfRadiusIsLargeEnough(int width, int height, int radius)
            {
                ...
                var blurrer = new NaiveBitmapBoxBlurrer(radius);
